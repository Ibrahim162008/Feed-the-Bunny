...
function preload()
{
  ...
  star1_Image = loadImage('star.png');
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   star1_display = createSprite(50, 20, 30, 30);
   star1_display.scale = 0.2;
   star1_display.addAnimation('empty',empty_star);
   star1_display.addAnimation('one',one_star);
   star1_display.addAnimation('two', two_star);
   star1 = createSprite(320, 50, 20, 20);
   star1.addImage(star1_Image);
   star1.scale = 0.02;
   star2 = createSprite(50, 320, 20, 20);
   star2.addImage(star1_Image);
   star2.scale = 0.02;
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if (collide(fruit,star1,20)==true) {
    star1.visible = false
    star1_display.changeAnimation('one');
   };
   if (collide(fruit,star2,40)==true) {
    star2.visible = false
    star1_display.changeAnimation('two');
   };
};
